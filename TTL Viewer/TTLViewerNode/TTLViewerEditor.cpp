...
TTLViewerEditor::TTLViewerEditor(GenericProcessor* parentNode)
...
TTLViewerEditor::~TTLViewerEditor()
{
    deleteAllChildren();
...
void TTLViewerEditor::initializeButtons()
{
    int w = 18;
    int h = 18;
    int xPad = 5;
...
Visualizer* TTLViewerEditor::createNewCanvas()
{

    TTLViewerNode* processor = (TTLViewerNode*) getProcessor();
    return new TTLViewerCanvas(processor);

}

void TTLViewerEditor::startRecording()
{

    TTLViewerCanvas* sdc = (TTLViewerCanvas*) canvas.get();

    sdc->startRecording();

}

void TTLViewerEditor::stopRecording()
{
...
// void TTLViewerEditor::updateSettings()
// {
// 	// called by base class

// }

// void TTLViewerEditor::updateVisualizer()
// {

// }


void TTLViewerEditor::buttonEvent(Button* button)
{
